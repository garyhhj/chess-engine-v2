...
const map CFile = C8 | C7 | C6 | C5 | C4 | C3 | C2 | C1;
const map DFile = D8 | D7 | D6 | D5 | D4 | D3 | D2 | D1;

const map EFile = E8 | E7 | E6 | E5 | E4 | E3 | E2 | E1;
const map FFile = F8 | F7 | F6 | F5 | F4 | F3 | F2 | F1;
...
const map Row3 = A3 | B3 | C3 | D3 | E3 | F3 | G3 | H3;
const map Row4 = A4 | B4 | C4 | D4 | E4 | F4 | G4 | H4;

const map Row5 = A5 | B5 | C5 | D5 | E5 | F5 | G5 | H5;
const map Row6 = A6 | B6 | C6 | D6 | E6 | F6 | G6 | H6;
